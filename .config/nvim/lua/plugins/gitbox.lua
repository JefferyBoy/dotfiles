...
local function run_cmd_and_show_result(cmd)
    ...
    vim.api.nvim_buf_set_name(nbuf, "Log:"..file)
...
function M.setup()
	vim.cmd([[command! -nargs=0 GitToolFileHistory :lua require("plugins.gitbox").show_git_file_history()]])
	vim.cmd([[command! -nargs=0 GitToolFileDiff :lua require("plugins.gitbox").show_git_file_diff()]])
	vim.cmd([[command! -nargs=0 GitToolFileDiffBranch :lua require("plugins.gitbox").show_diff_by_branch()]])
end
return M
